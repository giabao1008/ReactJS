                ...
                <div className="row">
                    ...
                    <div className="col-lg-4 col-md-6">
                        <div className="footer-section">
                            ...
                            <a className="logo" href="/"><img src="/images/logo.png" alt="this is alt"/></a>
                            <p className="copyright">Bona @ 2017. All rights reserved.</p>
                            <p className="copyright">Designed by <a href="https://colorlib.com" target="_blank" rel="noopener noreferrer">Colorlib</a></p>
                            <ul className="icons">
